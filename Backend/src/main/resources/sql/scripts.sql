...
INSERT INTO `accounts` (`customer_id`, `account_number`, `account_type`, `branch_address`,`balance`, `mobile_number`,`create_dt`)
 VALUES (1, 1865764534, 'Savings', '123 Main Street, New York', 4500,'9876548337',CURDATE());

INSERT INTO `accounts` (`customer_id`, `account_number`,`account_type`, `branch_address`,`balance`, `mobile_number`,`create_dt`)
 VALUES (3, 1865764533, 'Current','123 Main Street, New York',5000, '8975275858',CURDATE());
