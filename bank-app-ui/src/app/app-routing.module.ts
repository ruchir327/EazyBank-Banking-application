...
const routes: Routes = [
  ...
  // { path: 'create-account', component: CreateAccountComponent, canActivate: [AuthKeyClockGuard],data: {
  //   roles: ['USER']
  // }},
  // { path: 'transaction', component: TransactionsComponent, canActivate: [AuthKeyClockGuard],data: {
  //   roles: ['USER','ADMIN']
  // }},
